...
public class HomePage {
    ...
    @FindBy(xpath = "//div[text()='No precipitation within an hour']")
    ...
    public void verifyFunctionalityOfSearchWeatherInformation(String expectedUrlToBeContains, String expectedCityName) throws InterruptedException {
    ...
    public void verifySearchedCityWeatherInformation(String expectedTempText) {
        boolean tempElement = WaitUtils.waitForTheElementToBeVisible(driver, searchedCityTemperature, "SearchedCityTemperature");
        boolean humidityEle = WaitUtils.waitForTheElementToBeVisible(driver, searchedCityHumidity, "SearchedCityHumidity");
        boolean visibilityEle = WaitUtils.waitForTheElementToBeVisible(driver, searchedCityVisibility, "SearchedCityVisibility");
        String tempText = searchedCityTemperature.getText().trim();
        VerifyUtil.checkTwoTextsContainsOrNot(tempText, expectedTempText);
        VerifyUtil.assertThat(tempElement, "Temperature is displayed on the weather Information", "Temperature is not displayed on the weather Information");
        VerifyUtil.assertThat(humidityEle, "Humidity is displayed on the weather Information", "Humidity is not displayed on the weather Information");
        VerifyUtil.assertThat(visibilityEle, "Visibility is displayed on the weather Information", "Visibility is not displayed on the weather Information");
    }
    ...
    public void verifyWeatherDetailsAfterSearchedThroughWeatherInYourCitySearchBox(String cityName, String expectedTextOnNavigation, String expectedCityOnNavigation) throws InterruptedException {
        WaitUtils.waitForTheElementToBeVisible(driver, weatherInYourCitySearchBox, "WeatherInYourCitySearchBox");
        weatherInYourCitySearchBox.sendKeys(cityName);
        weatherInYourCitySearchBox.sendKeys(Keys.ENTER);
        ...
        VerifyUtil.checkTwoTextsAreEqualOrNot(weatherInYourCityText.getText().trim(), expectedTextOnNavigation);
        ...
        VerifyUtil.checkTwoTextsAreEqualOrNot(attributeValue, expectedCityOnNavigation);
    ...
    public void verifyFunctionalityOfSearchBoxesAfterEnteringInvalidCityNames(String invalidCityName, String expectedMessageForHomePageSearchBox, String expectedMessageForWeatherInYoyrCitySearchBox) throws InterruptedException {
        WaitUtils.waitForTheElementToBeVisible(driver, homePageSearchBox, "HomePageSearchBox");
        ...
        VerifyUtil.checkTwoTextsContainsOrNot(errorMessageForInvalidCityOnHomePage.getText().trim(), expectedMessageForHomePageSearchBox);
        WaitUtils.waitForTheElementToBeVisible(driver, weatherInYourCitySearchBox, "WeatherInYourCitySearchBox");
        weatherInYourCitySearchBox.sendKeys(invalidCityName);
        WaitUtils.waitForTheFixedTime(3);
        weatherInYourCitySearchBox.sendKeys(Keys.ENTER);
        WaitUtils.waitForTheElementToBeVisible(driver, errorMessageForInvalidCityOnWeatherInYourCity, "ErrorMessageOnWeatherInYourCity");
        VerifyUtil.checkTwoTextsContainsOrNot(errorMessageForInvalidCityOnWeatherInYourCity.getText().trim(), expectedMessageForWeatherInYoyrCitySearchBox);
    }
